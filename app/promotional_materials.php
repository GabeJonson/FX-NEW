...
<body class="hidden_menu internal_page" id="promotional_materials">
	<header>
<?php include "header.php"; ?>
	...
	<section id="promotional_materials_s1" class="pad">
		<div class="wrapper">
			<div class="partnership2_s2__left">
				<img src="img/promotional_materials/left.png" alt="left_img">
			</div>
			<div class="partnership2_s2__right">
				...
				<span class="partnership2_s2__h2">Промоционные<br> материалы</span>
				<p class="partnership2_s2__p_right">На этой странице Вы можете получить GIF и Flash баннеры с Вашей интегрированной  партнёрской ссылкой.
				<br><br>
				Для того, чтобы разместить наши Flash (.swf) баннеры на Вашем сайте, Вам необходимо установить файл Active Content javascript, разработанный компанией Adobe Systems.
				<br><br>
				Файл можно скачать с официального сайта компании <a href="#" class="a button_hover">тут.</a>
				</p>
			</div>
		</div>
	</section>

	<section id="promotional_materials_s2">
		<div class="wrapper">
			<div class="promotional_materials_s2_div promotional_materials_s2_div_1">
				<img src="img/promotional_materials/1.png" alt="">
			...
			<div class="promotional_materials_s2_div promotional_materials_s2_div_2">
				<img src="img/promotional_materials/2.png" alt="">
				<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took</span>
			</div>
			<div class="promotional_materials_s2_div promotional_materials_s2_div_3">
				<img src="img/promotional_materials/3.png" alt="">
				<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took</span>
			</div>
			<div class="promotional_materials_s2_div promotional_materials_s2_div_4">
				<img src="img/promotional_materials/4.png" alt="">
				<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took</span>
			</div>
		</div>
	</section>
