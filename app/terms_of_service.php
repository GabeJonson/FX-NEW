...
<body id="terms_of_service">
	<header>
<?php include "header.php"; ?>
	</header>

	<section id="header2" style="background-image: url(img/terms_of_service/bg.jpg)">
		<h2>FX Manager Terms of Service</h2>
	</section>

	<section id="terms_of_service__s1" class="pad">
		<div class="wrapper">
			<img src="img/terms_of_service/left.png" alt="left" class="terms_of_service__left">
			<div class="terms_of_service__right">
				<span class="terms_of_service__h2">FX Manager Terms of Service</span>
				<p>These Terms of Service constitute an online form of agreement, established between you (the Client) and FX Manager (the Company).
				<br><br>
				The present Terms of Service specify the conditions under which the Company shall provide the services to the Client related to conducting the copy trading operations on the Forex market.</a></p>
			</div>
		</div>
	</section>

	<section id="terms_of_service__s2" class="pad">
		<div class="wrapper">
			<ul class="terms_of_service__s2_ul_1 terms_of_service__s2_ul">
				<li>
					<div class="plus">+</div><span class="h4">1. General Provisions</span>
					<p>
						1.1. The FX Manager system is a software product developed and owned by the Company and designed to technically implement and automate all copying processes between FX Manager trading robot and the Client&#39;s account. 
						<br><br>
						1.2. Because of the global nature of the Internet, by opening an account with the Company, the Client agrees to abide the national laws of the country in which the Client resides.
						<br><br>
						1.3. The Company provides the Client with a detailed report of copy trading operations at the end of each trading day.
						<br><br>
						1.4. The Client may at sole discretion stop copy trading and withdraw money to a personal bank account.
					</p>
				</li>
				<li>
					...
					<p>
						...
						<br><br>
						3.2. The minimum amount of account funding is 7,000 EUR.
						<br><br>
						3.3. The Client pays all the expenses associated with a money transfer.
						<br><br>
				...
				<li>
					<div class="plus">+</div><span class="h4">5. Trading Package Types</span>
					<p>
						5.1. Depending on the amount the Client can create the following trading package types:
						<br><br>
						● The Trial trading package in the amount from 7,000 EUR to 10,000 EUR for 60 trading days term with 57% performance fee (the Trial trading package can be created by the Client only once for evaluation purposes);
						<br><br>
						● The Beginner trading package in the amount from 10,001 EUR to 20,000 EUR for 240 trading days term with 55% performance fee;
						<br><br>
						● The Standard trading package in the amount from 20,001 EUR to 30,000 EUR for 240 trading days term with 50% performance fee;
						<br><br>
						● The Intermediate trading package in the amount from 30,001 EUR to 40,000 EUR for 240 trading days term with 45% performance fee;
						<br><br>
						● The Advanced trading package in the amount from 40,001 EUR to 50,000 EUR for 240 trading days term with 40% performance fee;
						<br><br>
						● The Professional trading package in the amount from 50,001 EUR to 60,000 EUR for 240 trading days term with 35% Performance fee;
						<br><br>
						● The Expert trading package in the amount from 60,001 EUR to 70,000 EUR for 240 trading days term with 30% performance fee;
						<br><br>
						● The VIP trading package in the amount from 70,001 EUR to UNLIMITED EUR for 240 trading days term with 27% performance fee.
					</p>
				</li>
				<li>
				...
				<li>
					<div class="plus">+</div><span class="h4">9. Indemnification</span>
					<p>
						9.1. In case of any trading loss, such loss will be covered by the profit, previously made by the Client. The initial amount of the package is not involved in the loss coverage.
						<br><br>
						9.2. In case the total profit made by the Client cannot cover the trading loss, such loss is covered by the Company's reserve fund.
					</p>
				</li>
				<li>
				...
				<li>
					<div class="plus">+</div><span class="h4">13. Partnership Program</span>
					<p>
						13.1. The Client may take part in a 2-level partnership program. The Company pays the Client 5% commission from every package created by the referred clients (1st level). The Company pays the Client 2% commission from every package created by the clients of the referred clients (2nd level).
						<br><br>
						13.2. The partnership commission is instantly accrued to the Client's Current Account. It can be withdrawn or reinvested at any time.
						<br><br>
						13.3. The Client may take part in the partnership program without any active trading package.
						<br><br>
						13.4. In case the referred client requests a premature withdrawal of money, the partnership commission that was previously paid the Client will be deducted from the Client's Current Account balance.
						<br><br>
						13.5. In case the Company discovers the evidence of fraudulent use of the partnership program by the Client, the Company reserves the right to void all the accrued partnership commission and refuse further service to the Client.
					</p>
				</li>
				<li>
			...
			<ul class="terms_of_service__s2_ul_2 terms_of_service__s2_ul">
				...
				<li>
					...
					<p>
						...
						<br><br>
						14.4. The Client is responsible for the security and confidentiality of personal account access information.
						<br><br>
						14.5. The Client shall independently check the transactions in the account and timely inform the Company of any discrepancies or unauthorized access to the Client's account.
						<br><br>
						14.6. The Company ensures the safety of the Client's personal information.
						<br><br>
						14.7. The Company reserves the right to unilaterally refuse the Client to open an account at the Company's website.
					</p>
				</li>
				<li>
					...
					<p>
						...
						<br><br>
						16.2. The Company states that past trading performance is not necessarily indicative of future trading results.
					</p>
				</li>
				<li>
				...
				<li>
					<div class="plus">+</div><span class="h4">20. Language</span>
					<p>
						20.0. The main language of the Terms of Service is English.
						<br><br>
						20.0. For the Client convenience, the Company can provide the version of the Terms of Service in a different language. The translated version of the Terms of Service is of a merely informative character.
						<br><br>
						20.0. In case of variant readings of a translated version and the present Terms of Service in English, the Terms of Service in English is considered as a prior reference standard.
					</p>
				</li>
			</ul>
		</div>
